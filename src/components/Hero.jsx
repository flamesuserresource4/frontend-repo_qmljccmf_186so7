      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center py-16 sm:py-20">
          ...
          <div className="relative">
            <div className="aspect-[4/5] w-full rounded-2xl border border-gray-200 overflow-hidden bg-gradient-to-tr from-gray-900 via-gray-800 to-gray-900">
              ...
              {/* Subtle top gradient to improve text contrast without blocking interactions */}
